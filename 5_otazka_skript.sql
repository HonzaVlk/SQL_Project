...
-- Odstranil jsem podminku kladne zmeny cen, abych videl, zda nekdy neklesaly.     
 ...
 -- Data nepotvrzuji primou souvislost mezi vyraznym (ci jakymkoliv) rustem HDP a vyraznym rustem 
 -- cen vsech potravin. V nekterych letech po vyraznem predchozim rustu HDP sice vzrostly v roce nasledujicim 
 -- ceny potravin (a to i o dvouciferne hodnoty), ale stejne tak mezironce nektere potraviny
 -- zlevinly (take o dvojciferne hodnoty, napr. roky 2007/2008). Roky 2015/2016 zase ukazuji, ze
 -- po vyznamnem rustu HDP ceny mezironce zlevnily u vice nez poloviny sledovanych kategorii. 
 ...
 -- Data ukazuji i trend, kdy po nevysokem rustu HDP v jednom roce nasledoval pomerne vyrazny rust mezd 
